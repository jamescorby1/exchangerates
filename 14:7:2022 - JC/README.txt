...
How to run the code: 
1) Add you API key to the header dictionairy at the top of the page
2) There are two options when running the code:
    1) Execute the file with your API key added - python3 exchangerate.py
    2) Execute the extract_and_save_currency_rates(apiKey=YOUR HEADER, currencies=currencies, date=date) 
       in ther terminal - python3 exchangerates.py extract_and_save_currency_rates(...)
